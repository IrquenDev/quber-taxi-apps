    ...
    setState(() {
      _filteredClients = _allClients.where((client) {
        ...
        final phoneMatch = _phoneFilterController.text.isEmpty ||
            client.phone.contains(_phoneFilterController.text);

        // Filter by state
        final stateMatch = _selectedStateFilter == null ||
            client.accountState == _selectedStateFilter;
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.stars_outlined, size: 16),
                              Text(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButtonFormField<ClientAccountState?>(
                            ...
                            items: [
                              ...
                              ...ClientAccountState.values.map((state) =>
                                  DropdownMenuItem<ClientAccountState?>(
                                    value: state,
                                    child: Text(
