...
class _AdminSettingsPageState extends State<AdminSettingsPage> {
  ...
  bool get canSubmitNewPassword =>
      _newPasswordController.text.isNotEmpty && (_confirmPasswordController.text == _newPasswordController.text);

  bool get canSubmitNewConfigs =>
      _driverCreditController.text.isNotEmpty &&
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          ...
                                          validator: (value) => Workflow<String?>()
                                              .step(RequiredStep(errorMessage: localizations.requiredField))
                                              .step(ValidPercentageStep(
                                                  errorMessage: localizations.invalidCreditPercentage))
                                              .withDefault((_) => null)
                                              .proceed(value),
                                          onChanged: (s) => setState(() => _driverCreditController.text = s),
                                        ),
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  suffixIcon: IconButton(
                                                    ...
                                                    validator: (value) => Workflow<String?>()
                                                        .step(RequiredStep(errorMessage: localizations.requiredField))
                                                        .step(ValidPositiveNumberStep(
                                                            errorMessage: localizations.invalidPrice))
                                                        .breakOnFirstApply(true)
                                                        .withDefault((_) => null)
                                                        .proceed(value),
                                                    onChanged: (s) => setState(() {
                                    ...
                                    child: OutlinedButton(
                                      onPressed: () async {
                                        ...
                                        if (response.statusCode == 200) {
                                          ...
                                          showToast(
                                              context: context, message: localizations.errorChangingConfiguration);
                                        }
                                      },
                                      child: Text(
                                        localizations.saveButtonPanel,
                            ...
                            SizedBox(
                              child: TextFormField(
                                ...
                                validator: (value) => Workflow<String?>()
                                    .step(RequiredStep(errorMessage: localizations.requiredField))
                                    .step(MatchOtherStep(
                                        other: _newPasswordController.text,
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: InkWell(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(localizations.viewAllTrips, style: theme.textTheme.bodyLarge)
                                ],
                              ),
                            ),
                          ),
                          // Divider
                          Divider(height: 1.0, thickness: 3.0, color: Theme.of(context).colorScheme.surfaceContainer),
                          // Go to drivers
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 20.0),
                            child: InkWell(
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 20.0),
                            child: InkWell(
                              onTap: () => context.push(AdminRoutes.clientsList),
                              child: Row(
                                spacing: 12.0,
                                children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 20.0),
                            child: InkWell(
                              onTap: () => context.push(AdminRoutes.requestTaxi),
                              child: Row(
                                spacing: 12.0,
                                children: [
                                  const Icon(Icons.local_taxi, size: 22),
