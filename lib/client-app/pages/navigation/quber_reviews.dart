...
class QuberReviewsPage extends StatelessWidget {
  ...
  Widget _buildReviewItem(BuildContext context, Review review) {
    return Padding(
      ...
      child: Column(spacing: 8.0, crossAxisAlignment: CrossAxisAlignment.start, children: [
        // Profile Image + Name
        Row(
          spacing: 8.0,
          children: [const CircleAvatar(), Text(review.client.name)],
        ),
        // Rating + Date
        Row(
          spacing: 8.0,
          children: [
            Row(
              ...
              children: List.generate(
                5,
                (index) {
                  return Icon(index < review.rating ? Icons.star : Icons.star_border,
