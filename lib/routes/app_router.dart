...
import 'package:quber_taxi/common/pages/identity_verification/face-detection.dart';
...
import 'package:quber_taxi/driver-app/pages/create_account/driver_create_account.dart';
...
final GoRouter appRouter = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (context, state) => const DriverCreateAccount()),
      GoRoute(
      ...
      GoRoute(
          path: RoutePaths.clientCreateAccount,
