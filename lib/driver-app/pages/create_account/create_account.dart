...
class _CreateDriverAccountPageState extends State<CreateDriverAccountPage> {
  ...
  bool get _canSubmit => _formKey.currentState!.validate() && _selectedTaxi != null && _taxiImage != null;
                              ...
                              child: Theme(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      children:
                                          List.generate(TaxiType.values.length, (index) => _buildTaxiCardItem(index)),
                                    ),
                                  )
                                ]),
                              ),
    ...
    return Card(
      ...
      child: ExpansionTile(
        title: GestureDetector(
          ...
          child: ListTile(
              title: Row(spacing: 12.0, children: [
                SizedBox(width: 90, height: 48, child: Image.asset(taxi.assetRef(AssetDpi.xhdpi), fit: BoxFit.fill)),
                Text(TaxiType.nameOf(taxi, localizations),
                    style:
                        isSelected ? textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold) : textTheme.bodyMedium)
              ]),
              selected: isSelected,
              contentPadding: EdgeInsets.zero),
        ),
        tilePadding: const EdgeInsets.symmetric(horizontal: 12.0),
        childrenPadding: const EdgeInsets.only(left: 12.0, right: 12.0, bottom: 6.0),
        children: [Text(TaxiType.descriptionOf(taxi, localizations))],
      ),
    );
  }
