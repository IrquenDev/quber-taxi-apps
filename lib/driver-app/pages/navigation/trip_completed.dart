                  ...
                  children: [
                    ...
                    CircleStack(
                        ...
                        prototypeBuilder: (index) {
                          final imageUrl =
                              index == 0 ? widget.travel.client.profileImageUrl : widget.driver.taxi.imageUrl;
                          if (imageUrl != null) {
                ...
                Column(
                  ...
                  children: [
                    ...
                    TripDetailRow(
                      ...
                      text:
                          widget.duration != null ? '${widget.duration!.toStringAsFixed(0)} ${loc.minutesLabel}' : '-',
                    ),
                    TripDetailRow(
                    ...
                    TripDetailRow(
                        ...
                        text:
                            '${(widget.travel.driver!.credit - widget.driver.credit).toStringAsFixed(2)} ${loc.currencyLabel}'),
                  ],
                ),
              ],
            ),
