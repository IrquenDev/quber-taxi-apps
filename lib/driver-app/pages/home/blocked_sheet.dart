...
/// Bottom sheet widget that displays when a driver account is blocked.
/// This sheet cannot be dismissed by the user and will only disappear when
/// the driver's account state changes to enabled.
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 24.0),
            child: Text(
              localizations.driverBlockedMessage,
